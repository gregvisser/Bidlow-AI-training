  ...
  for (const track of TRACKS) {
    ...
    const path = await prisma.learningPath.upsert({
      ...
      update: {
        ...
        outcomeType: track.outcomeType,
        outcomeSummary: track.outcomeSummary,
        providerCertificationUrl: track.providerCertificationUrl ?? undefined,
        providerCertificationMapping: track.providerCertificationMapping ?? undefined,
        isPublic: true,
        isFeatured: true,
    ...
    for (const c of track.courses) {
      ...
      const course = await prisma.course.upsert({
        ...
        update: {
          ...
          providerCertificationUrl: c.providerCertificationUrl ?? undefined,
          providerCertificationMapping: c.providerCertificationMapping ?? undefined,
